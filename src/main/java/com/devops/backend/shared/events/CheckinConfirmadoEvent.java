...
@Getter
public class CheckinConfirmadoEvent extends ApplicationEvent {

    private final Ticket ticket;
    private final Evento evento;
    private final String emailDestinatario;

    public CheckinConfirmadoEvent(Object source, Ticket ticket, Evento evento, String emailDestinatario) {
        super(source);
        this.ticket   = ticket;
        this.evento   = evento;
