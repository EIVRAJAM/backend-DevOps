...
public class AuthController {
         ...
         * 
         * @Operation(summary = "Obtener JWT después de autenticación OAuth2",
         * description =
         * "Endpoint seguro para obtener el JWT del sistema tras autenticarse con Google OAuth2. "
         * +
         ...
         * "JWT obtenido exitosamente. Retorna token y datos del usuario."),
         * 
         * @ApiResponse(responseCode = "401", description =
         * "No autenticado. Usuario no tiene sesión válida de OAuth2."),
         * 
         * @ApiResponse(responseCode = "500", description =
         * "Error interno al obtener el JWT.")
         * })
         ...
         * return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
         * .body(Map.of("error", "No autenticado", "message",
         * "No hay sesión OAuth activa"));
         * }
         * 
         ...
         * log.warn("OAuth2 success endpoint: usuario no encontrado para email {}",
         * email);
         * return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
         ...
         * log.info("Usuario encontrado: {} (ID: {})", usuario.getNombres(),
         ...
         * log.
         * warn("OAuth2 success endpoint: no hay sesión GOOGLE activa para usuario {}",
         * usuario.getIdUsuario());
         * return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
         * .body(Map.of("error", "No autenticado", "message",
         * "No hay sesión OAuth activa"));
         ...
         * .compact();
         * 
         * log.info("JWT obtenido exitosamente para usuario OAuth: {} (email: {})",
         * usuario.getIdUsuario(), email);
         * 
